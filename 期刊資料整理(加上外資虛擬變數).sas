...
proc import datafile="/home/u64061874/patent_regression_data3.xlsx"
...
proc import datafile="/home/u64061874/patent_regression_data3.xlsx"
    out=patent_regression_data3 dbms=xlsx replace;
    getnames=yes;
run;
...
/* ========= 3) 合併（左併，以 patent3 為主） ========= */
proc sql;
    create table patent_regression_data5 as
    select 
        a.*,
        b.foreign_company,
        b.foreign_dummy
...
data patent_regression_data5;
    ...
    set patent_regression_data5;
run;

/* ========= 5) 按 year、companyID 排序 ========= */
proc sort data=patent_regression_data5;
    by year companyID;
run;
...
/* 匯出結果 */
proc export data=patent_regression_data5
    outfile="/home/u64061874/patent_regression_data5.xlsx"
    dbms=xlsx replace;
    sheet="patent_regression_data5";
    putnames=yes;
run;